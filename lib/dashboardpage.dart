...
import 'package:ui_travel/detailpage.dart';
      ...
      children: <Widget>[
        ...
        Container(
            ...
            child: ListView(
              children: <Widget>[
                _buildListItem(
                    'assets/jg.jpg', 'Jogja', 'Wes tau foto neng Tugu durung?'),
                _buildListItem(
                    'assets/sby.jpg', 'Surabaya', 'Ayo dolan mbene rek!'),
                ...
                InkWell(
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: (context) =>
                              DetailPage(imgPath: imgPath, title: prov)));
                    },
                    child: Container(
                      height: 50.0,
                      width: 125.0,
